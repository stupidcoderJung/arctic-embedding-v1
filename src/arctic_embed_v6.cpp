...
public:
    ArcticEmbedTiny(const std::string& model_path, const std::string& vocab_path = "") : unk_token_id_(100), cls_token_id_(101), sep_token_id_(102), pad_token_id_(0), max_length_(512) {
        ...
        session_options.SetInterOpNumThreads(4);  // Changed from 2 to 4 threads for better performance
        session_options.SetGraphOptimizationLevel(ORT_ENABLE_ALL);  // Added graph optimization
